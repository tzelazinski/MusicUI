...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\tzela\\Documents\\Programowanie\\Java\\UdemyProjekty\\MusicUI\\" + DB_NAME;
    ...
    public static final String QUERY_VIEW_SONG_INFO = "SELECT " + COLUMN_ARTIST_NAME + ", " + COLUMN_SONG_ALBUM + ", " + COLUMN_SONG_TRACK + " FROM " + TABLE_ARTIST_SONG_VIEW +
    ...
    public List<Artist> queryArtists(int sortOdrder) {
        
        StringBuilder sb = new StringBuilder("SELECT * FROM ");
        sb.append(TABLE_ARTISTS);
        if (sortOdrder != ORDER_BY_NONE) {
            sb.append(" ORDER BY ");
            sb.append(COLUMN_ARTIST_NAME);
            sb.append(" COLLATE NOCASE ");
            if (sortOdrder == ORDER_BY_DESC) {
                sb.append("DESC");
            } else {
                sb.append("ASC");
            }
    ...
    public List<String> queryAlbumsForArtist(String artistName, int sortOrder) {
        ...
        try (Statement statement = conn.createStatement();
            ...
            while (results.next()) {
                albums.add(results.getString(1)); //only one column in the results table, not in the albums table!!!!!!!!
            }
    ...
    public void insertSong(String title, String artist, String album, int track) {
        try {
            ...
            System.out.println("Insert song exceptio: " + e.getMessage());
            try {
